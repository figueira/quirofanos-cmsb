...
class TextoMostrable():
    ...
    BUSCAR = _(u'Buscar')
    ENVIAR = _(u'Enviar')
    ENVIANDO = _(u'Enviando...')
    ACEPTAR = _(u'Aceptar')
    CANCELAR = _(u'Cancelar')
    CANCELANDO = _(u'Cancelando...')
    CANCELAR_SOLICITUD = _(u'Cancelar Solicitud')
    CANCELAR_INTERVENCION_QUIRURGICA = _(u'Cancelar Intervención Quirúrgica')
    ...
    LABEL_BUSCAR_CEDULA = _(u'Ingrese su número de cédula:')
    ...
    OLVIDO_CONTRASENA = _(u'Olvidó su contraseña?')
    BUSCANDO = _(u'Buscando...')
    LABEL_CONTRASENA_ACTUAL = _(u'Contraseña Actual:')
    LABEL_CONTRASENA_NUEVA = _(u'Nueva Contraseña:')
    LABEL_CONTRASENA_NUEVA_REPETIDA = _(u'Repita Nueva Contraseña:')
    ACTUALIZAR = _(u'Actualizar')
    ACTUALIZANDO = _(u'Actualizando...')
    ESPERE = _(u'Espere...')
    AGREGAR = _(u'Agregar')
