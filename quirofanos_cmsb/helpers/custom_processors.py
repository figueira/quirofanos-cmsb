...
def constantes_texto(request):
    ...
    datos['LABEL_PROCEDIMIENTOS_QUIRURGICOS'] = TextoMostrable.LABEL_PROCEDIMIENTOS_QUIRURGICOS
    datos['LABEL_SISTEMA_CORPORAL'] = TextoMostrable.LABEL_SISTEMA_CORPORAL
    datos['LABEL_ORGANO_CORPORAL'] = TextoMostrable.LABEL_ORGANO_CORPORAL
    datos['LABEL_PROCEDIMIENTO'] = TextoMostrable.LABEL_PROCEDIMIENTO
    datos['LABEL_PROCEDIMIENTO_ABREVIADO'] = TextoMostrable.LABEL_PROCEDIMIENTO_ABREVIADO
