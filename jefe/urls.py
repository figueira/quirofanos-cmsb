...
urlpatterns = patterns('jefe.views',
    ...
    url(r'^aceptar_solicitud_usuario$', 'aceptar_solicitud_usuario', name='aceptar_solicitud_usuario'),
    url(r'^rechazar_solicitud_usuario$', 'rechazar_solicitud_usuario', name='rechazar_solicitud_usuario'),
)
